		...
		<div className="section">
			...
			<div className="content-block-highlight mb-8">
				...
				<p className="text-xl text-gray-300 leading-relaxed">
					Research and Development of Reinforcement-Learning Gait Optimization for a Feline Quadruped Robot.
				</p>
			</div>
...
console.log(example);</code></pre>
				...
				<div className="image-gallery">
					<div className="gallery-item">
						<img src="/project/image1.jpg" alt="Description" />
						<div className="gallery-item-title">System Architecture</div>
						<div className="gallery-item-description">
						Initial prototype of the quadruped locomotion system
						</div>
					</div>
					
					<div className="gallery-item">
						<img src="/project/image2.jpg" alt="Description" />
						<div className="gallery-item-title">Control Interface</div>
						<div className="gallery-item-description">
					...
					<div className="gallery-item">
						<img src="/project/image3.jpg" alt="Description" />
						<div className="gallery-item-title">Field Testing</div>
						<div className="gallery-item-description">
						Robot performing dynamic maneuvers
						</div>
					</div>
				</div>
			</div>
